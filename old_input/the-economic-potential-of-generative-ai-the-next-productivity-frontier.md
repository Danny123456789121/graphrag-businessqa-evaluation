# Document name:the-economic-potential-of-generative-ai-the-next-productivity-frontier
...
2. Excluded software engineering.  
3. Includes aerospace, defense, and auto manufacturing.  
4. Source: Compendium: Industry Service (CIS), IHS Markit; Oxford Economics; McKinsey Corporate and Business Functions database; McKinsey Manufacturing and Supply Chain 360; McKinsey Sales Navigator; Ignite; a McKinsey database; McKinsey analysis.

# Generative AI Value Potential Across Industries
...
| Industry                               | Total value potential per industry, $ billion (% of industry revenue) | Value potential, as % of operating profits | Product R&D, software engineering | Customer operations | Marketing and sales | Other functions |
|----------------------------------------|-----------------------------------------------------------------------|-------------------------------------------|----------------------------------|---------------------|--------------------|------------------|
| Banking                                | 200–340 (3–5%)                                                        | 9–15                                      | Legacy code conversion           | Customer emergency interactive voice response (IVR) | Custom retail banking offers | Risk model documentation |
|                                        |                                                                       |                                           | Optimize migration of legacy frameworks with natural-language translation capabilities | Partially automate, accelerate, and enhance resolution rate of customer emergencies through generative AI–enhanced IVR interactions (e.g., for credit and losses) | Push personalized marketing and sales content tailored for each client based on profile and history (e.g., personalized nudges), and generate alternatives for A/B testing | Create model documentation, and scan for missing documentation and relevant regulatory updates |
| Retail and consumer packaged goods*    | 400–660 (1–2%)                                                       | 27–44                                     | Consumer research                | Augmented reality–assisted customer support | Assist copy writing for marketing content creation | Procurement suppliers process enhancement |
|                                        |                                                                       |                                           | Accelerate consumer research by testing scenarios, and enhance customer targeting by creating "synthetic customers" to practice with | Rapidly inform the workforce in real time about the status of products and consumer preferences | Accelerate writing of copy for marketing content and advertising scripts | Draft playbooks for negotiating with suppliers |
| Pharma and medical products            | 60–110 (3–5%)                                                        | 15–25                                     | Research and drug discovery      | Customer documentation generation | Generate content for commercial representatives | Contract generation |
|                                        |                                                                       |                                           | Accelerate the selection of proteins and molecules best suited as candidates for new drug formulation | Draft medication instructions and risk notices for drug resale | Prepare scripts for interactions with physicians | Draft legal documents incorporating specific regulatory requirements |

*Operating profit based on average profitability of selected industries in the 2020–22 period.  
*Includes auto retail.
...
*Previous assessment of work automation before the rise of generative AI. Source: McKinsey Global Institute analysis*  
*McKinsey & Company*  
*The economic potential of generative AI: The next productivity frontier*
...
¹ *The AI Index 2023 annual report*, Institute for Human-Centered AI, Stanford University, April 2023.
...
B. We estimated the functional cost for a function as a percentage of total revenue in an industry based on published data, industry experts, and McKinsey benchmarks.
...
Where \(F(t)\) is the installed base fraction (that is, adoption of given technology or product) and \(f(t)\) is the corresponding rate of change.
